...
namespace MathStudy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void Header(string title = "", string subtitle = "", ConsoleColor foreGroundColor = ConsoleColor.DarkCyan, int windowWidthSize = 150)
            {
            ...
            string CenterText(string content = "", string decorationString = "", int windowWidthSize = 150)
            {
